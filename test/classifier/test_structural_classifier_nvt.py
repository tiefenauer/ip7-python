...
testee = StructuralClassifierNVT(args, preprocessor)


class TestStructuralClassifierNVT(unittest.TestCase):
    def test_compare_tags(self):
        assert_that(structural_classifier_nvt.compare_tag('h1', 'h2'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h2', 'h3'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h3', 'h4'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h1', 'p'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h2', 'p'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h3', 'p'), is_(less_than(0)))
        assert_that(structural_classifier_nvt.compare_tag('h4', 'p'), is_(less_than(0)))

    def test_get_higher_tag(self):
        assert_that(structural_classifier_nvt.get_higher_tag('h1', 'h2'), is_('h1'))
        assert_that(structural_classifier_nvt.get_higher_tag('h2', 'h3'), is_('h2'))
        assert_that(structural_classifier_nvt.get_higher_tag('h3', 'h4'), is_('h3'))
        assert_that(structural_classifier_nvt.get_higher_tag('h1', 'p'), is_('h1'))
        assert_that(structural_classifier_nvt.get_higher_tag('h2', 'p'), is_('h2'))
        assert_that(structural_classifier_nvt.get_higher_tag('h3', 'p'), is_('h3'))
        assert_that(structural_classifier_nvt.get_higher_tag('h4', 'p'), is_('h4'))
    ...
    def test_top_n_returns_top_n(self):
        ...
        # act
        result = structural_classifier_nvt.top_n(tagged_words, 'N', 3)
        # assert
