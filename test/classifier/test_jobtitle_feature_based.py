...
from src.extractor import jobtitle_extractor_fts_with_tags
...
class TestFeatureBasedJobtitleClassification(unittest.TestCase):
    ...
    def test_extract_features_no_match_returns_empty_list(self):
        ...
        # act
        features = jobtitle_extractor_fts_with_tags.extract_features(tags, jnv)
        # assert
    ...
    def test_count_variants_returns_correct_job(self):
        ...
        tag = 'Polymechaniker'
        # act
        result = jobtitle_extractor_fts_with_tags.count_variants(tag, create_gender_variants('Polymechaniker'))
        # assert
    ...
    def test_count_variants_with_variant_slash_hyphen_euse_returns_correct_job_title(self):
        ...
        tag = 'Coiffeur/-euse'
        # act
        result = jobtitle_extractor_fts_with_tags.count_variants(tag, create_gender_variants('Coiffeur'))
        # assert
        assert_that(result, contains_inanyorder(
            ('Coiffeur/-euse', 1)
        ))
    ...
    def test_count_variants_with_variant_slash_hyphen_frau_returns_correct_job_title(self):
        ...
        tag = 'Kaufmann/-frau'
        # act
        result = jobtitle_extractor_fts_with_tags.count_variants(tag, create_gender_variants('Kaufmann'))
        # assert
        assert_that(result, contains_inanyorder(
            ('Kaufmann/-frau', 1)
        ))
    ...
    def test_count_variants_with_variant_mw_returns_correct_job_title(self):
        ...
        # act
        result = jobtitle_extractor_fts_with_tags.count_variants(string, create_gender_variants('Polymechaniker'))
        # assert
        assert_that(result, contains_inanyorder(
    ...
    def test_count_variants_multi_variants_returns_correct_job_count(self):
        ...
        # act
        result = jobtitle_extractor_fts_with_tags.count_variants(tag, variants)
        # assert
        assert_that(result, contains_inanyorder(
            ('Polymechaniker/in', 1),
            ('Coiffeur/-euse', 1),
