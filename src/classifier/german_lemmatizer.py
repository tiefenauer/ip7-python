...
python german_lemmatizer.py tiger_release_[...].conll09
...
class GermanLemmatizer(object):
    ...
    def __init__(self, **kwargs):
        ...
        if 'lemmata' in kwargs:
            ...
            self.load_from_pickle(german_lemmatizer_path)
...
if __name__ == '__main__':
    ...
    lemmatizer = GermanLemmatizer(tiger_corpus=corpus_file, use_pattern_module=True)

    print("saving as pickle file '%s'" % german_lemmatizer_path)
    lemmatizer.save_to_pickle(german_lemmatizer_path)
